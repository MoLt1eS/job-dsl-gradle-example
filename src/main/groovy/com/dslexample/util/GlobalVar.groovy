...
final class GlobalVar {
    ...
    static String[] CIAB_PROJECTS = ["ciab-broadband", "ciab-carinsurance", "ciab-core", "ciab-customer-cloud", "ciab-finance", "ciab-landing", "ciab-learningcenter", "ciab-payment", "ciab-sim", "ciab-telcoproviders", "ciab-travelinsurance", "ciab-views", "ciab-base"]
